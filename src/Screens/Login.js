...
import { AuthContext } from "../../Context/AuthProvider";
 ...
 function Login({navigation}) {
    ...
    const forgotPassword = ()=>{
        Alert.alert("Sorry!","This feature is not available yet. May be available in next update. You can always create a new account.",["Ok"])
    }
    if(error!=null){
        console.log(error);
        ...
        if(error=="Error: [auth/user-not-found] There is no user record corresponding to this identifier. The user may have been deleted."){
     ...
     <View style={styles.container}>
       ...
       <View style={styles.loginContainer}>
          ...
          <Text style={styles.loginText}>Sign In</Text>
           ...
           <TouchableOpacity style={styles.forgotConatiner} onPress={()=>forgotPassword()}>
