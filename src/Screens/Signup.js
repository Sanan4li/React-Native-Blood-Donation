...
import { AuthContext } from "../../Context/AuthProvider";
 ...
 function Signup({navigation}) {
    ...
    if(error!=null){
        ...
        if(error=="Error: [auth/email-already-in-use] The email address is already in use by another account."){
            errorMessage = "Email is already in use by another account! Try again with different email.";
        }
    ...
    const loadingIndicator = <View style={{justifyContent:"center", backgroundColor:"#fe6e58", flex:1, alignItems:"center"}}><ActivityIndicator size={60} color="white"/></View> ;
           ...
           <Text style={styles.createAccountText}>Create Account</Text>
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.inputConatiner}>
                    ...
                    <TextInput style={styles.textInput} textContentType="password" secureTextEntry={true}
                ...
                <View style={styles.inputConatiner}>
                    ...
                    />
                    {!data.isPasswordSame && <Text style={styles.errorMessage}>Passwords didn't match! </Text>}
                </View>
            </View>
            <View style={styles.signUpContainer}>
                <TouchableOpacity style={styles.signUpButton} onPress={()=>SignUpNow()}>
